...
<?php
  if(isset($_POST["add_btn"])){
    $get_course = mysqli_real_escape_string($connection,$_POST["course"]);
    $check = mysqli_query($connection,"SELECT * FROM college_course WHERE course = '$get_course'");
    ...
    if($check_row > 0){
      ...
      mysqli_query($connection,"INSERT INTO college_course (course) VALUES ('$get_course')");
...
<?php
  if(isset($_POST["update_btn"])){
    ...
    mysqli_query($connection,"UPDATE college_course SET course = '$course' WHERE id = '$id'");
    $msg = "<div class='alert alert-success' role='alert' style='width:99%;'>
...
<?php
  if(isset($_POST["delete_btn"])){
    ...
    mysqli_query($connection,"DELETE FROM college_course WHERE id = '$delete_id'");
    $msg = "<div class='alert alert-success' role='alert' style='width:99%;'>
...
<html lang="en">
  <head>
    ...
    <title>Admin | College Course</title>
  </head>
  <body>
    <?php
    ...
    <div class="main-content">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><i class="fas fa-chalkboard"></i> College course</h1>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-chalkboard"></i> Course</h5>
     ...
     <?php
        // PAGINATION AND SEARCH
            if(isset($_POST["search_btn"])){
                ...
                $start = 0;
                $limit = 5;
                $total = mysqli_query($connection,"SELECT * FROM college_course WHERE course LIKE '%".$search."%' ORDER BY `college_course`.`course` ASC");
              ...
              $fetch = mysqli_query($connection,"SELECT * FROM college_course WHERE course LIKE '%".$search."%' ORDER BY `college_course`.`course` ASC LIMIT $start,$limit");
            }
            else{
                 $start = 0;
                $limit = 5;
                $total = mysqli_query($connection,"SELECT * FROM college_course ORDER BY `college_course`.`course` ASC");
                $total_rows = mysqli_num_rows($total);
                if(isset($_GET["id"])){
                  $id = $_GET["id"];
                  $start = ($id-1)*$limit;
                ...
                $page = ceil($total_rows/$limit);
              $fetch = mysqli_query($connection,"SELECT * FROM college_course ORDER BY `college_course`.`course` ASC LIMIT $start,$limit");
            }
     ?>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name" name="course" value="<?php echo $course;?>">
                        </div>
                    </div>
                    <div class="modal-footer">
