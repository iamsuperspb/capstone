...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='lpu') {
$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='lpu') {
$eid=@$_GET['eid'];
...
if(@$_GET['q']== 'quiz' && @$_GET['step']== 2) {
	...
	if($sn == 1)
	{
	$q=mysqli_query($connection,"INSERT INTO history VALUES('$name','$email','$eid' ,'0','0','0','0',NOW())")or die('Error');
	}
	...
	if($sn == 1)
	{
	$q=mysqli_query($connection,"INSERT INTO history VALUES('$name','$email','$eid' ,'0','0','0','0',NOW() )")or die('Error137');
	}
