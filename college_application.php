...
<?php
  ...
  if(isset($_POST["submit_btn"])){
    ...
    $schooladd = strtoupper($schooladd);
  ...
  $validate_slot_amses = mysqli_query($connection,"SELECT COUNT(*) AS am_slot FROM college_applicant_information WHERE date_exam = '$date_exam' AND time_exam = '9:00 AM'");
  ...
  $validate_slot_pmses = mysqli_query($connection,"SELECT COUNT(*) AS pm_slot FROM college_applicant_information WHERE date_exam = '$date_exam' AND time_exam = '1:30 PM'");
  ...
  $pm_slot = $result_pmses["pm_slot"];
    if($am_slot <= 39){
      if($time_exam == "9:00 AM"){
        ...
        if($fname && $mname && $lname && $date_exam && $time_exam && $age && $gender && $telno && $mobileno && $school && $schoolyr && $sem && $citizen && $emailadd && $schooladd && $firstchoice && $secondchoice && $thirdchoice){
          ...
          $validate_am = mysqli_query($connection,"SELECT * FROM college_applicant_information WHERE applicant_no = '$generate_appno'");
          ...
          if($check_am > 0){
            ...
            mysqli_query($connection,"INSERT INTO college_applicant_information(applicant_no,fname,mname,lname,age,gender,telno,mobileno,school,schoolyear,semester,citizenship,emailadd,schooladd,homeadd,firstchoice,secondchoice,thirdchoice,date_exam,time_exam,status,exam_set) VALUES ('$generate_appno','$fname','$mname','$lname','$age','$gender','$telno','$mobileno','$school','$schoolyr','$sem','$citizen','$emailadd','$schooladd','$homeadd','$firstchoice','$secondchoice','$thirdchoice','$date_exam','$time_exam','Pending','".generateRandomString()."')");
    ...
    if($pm_slot <= 39){
      if($time_exam == "1:30 PM"){
         $generate_appno1 = "ANCL".$appno.$date."PM";
        if($fname && $mname && $lname && $date_exam && $time_exam && $age && $gender && $telno && $mobileno && $school && $schoolyr && $sem && $citizen && $emailadd && $schooladd && $firstchoice && $secondchoice && $thirdchoice){
          $fullname = ucfirst($fname)." " . ucfirst($mname[0]) . ". " . ucfirst($lname);
          $validate_pm = mysqli_query($connection,"SELECT * FROM college_applicant_information WHERE applicant_no = '$generate_appno1'");
          ...
          if($check_pm > 0){
            ...
            mysqli_query($connection,"INSERT INTO college_applicant_information(applicant_no,fname,mname,lname,age,gender,telno,mobileno,school,schoolyear,semester,citizenship,emailadd,schooladd,homeadd,firstchoice,secondchoice,thirdchoice,date_exam,time_exam,status,exam_set) VALUES ('$generate_appno1','$fname','$mname','$lname','$age','$gender','$telno','$mobileno','$school','$schoolyr','$sem','$citizen','$emailadd','$schooladd','$homeadd','$firstchoice','$secondchoice','$thirdchoice','$date_exam','$time_exam','Pending','".generateRandomString()."')");
              header("location:index");
          }
        }
      }
    ...
    <div class="main-application">
      ...
      <table width="90%" style="margin:20px;">
        <tr>
          ...
          <td> </td>
          <td><input style="text-transform: uppercase;" type="text" id="fname" name="fname" class="form-control" required=""></td>
        </tr>
        <tr>
          <td style="text-align: right; height: 50px;"><label>MIDDLE NAME:</label></td>
          <td> </td>
          <td><input style="text-transform: uppercase;" type="text" id="mname" name="mname" class="form-control" required=""></td>
        </tr>
        <tr>
          <td style="text-align: right; height: 50px;"><label>LAST NAME:</label></td>
          <td> </td>
          <td><input style="text-transform: uppercase;" type="text" id="lname" name="lname" class="form-control" required=""></td>
        </tr>
        ...
        <tr>
          ...
          <td><!-- <input id="datepicker1" name="date_exam" required=""> -->
            <input style="text-transform: uppercase;" type="text" class="form-control" name="date" id="datepicker" autocomplete="off" readonly="" required="">
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td> </td>
          <td><input style="text-transform: uppercase;" type="text" name="age" id="age" class="form-control" onkeypress="return isNumberKey(event)" required=""></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td> </td>
          <td><input style="text-transform: uppercase;" type="text" name="school" id="school" class="form-control" required=""></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td> </td>
          <td><input style="text-transform: uppercase;" type="email" name="emailadd" id="age" class="form-control" required=""></td>
        </tr>
        <tr>
          ...
          <td>
              ...
              <label class="radio-inline"><input type="radio" name="semester" value="Summer">Summer</label>
            </td>
        </tr>
      </table>
