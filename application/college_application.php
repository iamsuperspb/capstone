      ...
      if($time_exam == "9:00 AM"){
        ...
        if($fname && $mname && $lname && $date_exam && $time_exam && $age && $gender && $telno && $mobileno && $school && $schoolyr && $sem && $citizen && $emailadd && $schooladd && $firstchoice && $secondchoice && $thirdchoice){
          ...
          if($check > 0){
            ...
            mysqli_query($connection,"INSERT INTO college_applicant_information(applicant_no,fname,mname,lname,age,gender,telno,mobileno,school,schoolyear,semester,citizenship,emailadd,schooladd,homeadd,firstchoice,secondchoice,thirdchoice,date_exam,time_exam,status) VALUES ('$generate_appno','$fname','$mname','$lname','$age','$gender','$telno','$mobileno','$school','$schoolyr','$sem','$citizen','$emailadd','$schooladd','$homeadd','$firstchoice','$secondchoice','$thirdchoice','$date_exam','$time_exam','Pending')");
      ...
      if($time_exam == "1:30 PM"){
        ...
        if($fname && $mname && $lname && $date_exam && $time_exam && $age && $gender && $telno && $mobileno && $school && $schoolyr && $sem && $citizen && $emailadd && $schooladd && $firstchoice && $secondchoice && $thirdchoice){
          ...
          if($check > 0){
            ...
            mysqli_query($connection,"INSERT INTO college_applicant_information(applicant_no,fname,mname,lname,age,gender,telno,mobileno,school,schoolyear,semester,citizenship,emailadd,schooladd,homeadd,firstchoice,secondchoice,thirdchoice,date_exam,time_exam) VALUES ('$generate_appno','$fname','$mname','$lname','$age','$gender','$telno','$mobileno','$school','$schoolyr','$sem','$citizen','$emailadd','$schooladd','$homeadd','$firstchoice','$secondchoice','$thirdchoice','$date_exam','$time_exam','Pending')");
            echo "<script language='javascript'>
                  alert('Successfully Added');
                  </script>";
          }
